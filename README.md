...
原版 MOD 低版本由 [Gim949](https://www.mcmod.cn/class/2627.html) 制作，本项目将其移植至 **Minecraft 1.20.1/1.19.2（未来可能会支持更多版本）**，并在此基础上进行了大量重构与功能扩展。
...
## 更新
### v4.0
该版本未引入任何新玩法和新特性，着重于bugfix与性能优化以及向下迁移适配，强烈建议更新。
- 适配了更多MC版本。
- 传送门系统深度性能优化重构，大幅提升传送性能。
- 矿石生成系统优化，优化了矿石散落分布算法，优化了矿工天堂矿石生成规则与概率，修复了外部 Mod 矿石检测可能遗漏的问题。
- 矿工天堂维度环境优化，调整了矿工天堂亮度、雾和矿石生成效果。
- 跨 Mod 矿石兼容性增强，矿工天堂中对于其它mod引入的矿物支持更佳。
- 优化了若干性能 bug。

> 需要注意，由于1.16.5/1.12.2低版本与1.18+高版本在地形生成噪声算法部分存在较大差异，而矿工天堂维度的地形生成比较依赖原生算法，所以矿工天堂维度中的地形在高版本与低版本可能存在较大差异，但是不影响正常游玩。
